...
static std::string TexFile[TEX_MAX] = 
{
	...
	"data/texture/player_red.dds",
	"data/texture/player_blue.dds",
	"data/texture/player_water.dds",
	"data/texture/player_orange.dds",
	"data/texture/player_white.dds",
	"data/texture/player_rin.dds",
