...
//クラス定義
class CEffect2D :public CObject
{
public:
	CEffect2D();
	virtual ~CEffect2D(){}
	...
	//XY平面で生成される
	//=============================================================================
	static CEffect2D* Create(const VECTOR3& pos,const VECTOR2& size,const VECTOR3& rot = VECTOR3(0,0,0),const COLOR& color = COLOR(1.0f,1.0f,1.0f,1.0f));
